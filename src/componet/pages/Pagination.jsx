...
export default function Pagination({ onCardClick }) {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        ...
        setMovies(data.results); // የዛን ገጽ 20 ፊልሞች ብቻ ይይዛል
  ...
  return (
    ...
    <div className="w-full bg-black min-h-screen p-8 text-white">
      <h2 className="text-2xl font-bold mb-6 text-cyan-400">Upcoming Movies (Page {page})</h2>
